...
## How much RAM do you need for a Garry’s Mod Server?
...
In order to win, hunters must find and eliminate all props within the time limit. If they fail, then the props win.
