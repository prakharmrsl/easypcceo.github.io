...
If you can, I'd recommend spending the extra money on a [600 dollar gaming PC](/budget-pcs/600/) instead, as you'll get a lot more performance for your money.
...
<p>The Ryzen 3 2200G is the newest addition to the Ryzen 3 line. Featuring four physical cores and a base clock speed of 3.5 <a target="_blank" rel="nofollow" href="https://www.quora.com/What-does-GHz-mean-How-does-it-relate-to-processor-speed">GHz</a>, this AMD <a target="_blank" rel="nofollow" href="https://www.digitaltrends.com/computing/what-is-a-cpu/">CPU</a> punches above its weight class. It's a fantastic processor for a budget gaming PC, thanks to its strong performance and low price tag.</p>
...
However, most games are well-optimized and draw mostly from the <a target="_blank" rel="nofollow" href="https://www.itpro.co.uk/hardware/30399/what-is-a-gpu">GPU</a> (Graphics Processing Unit). This means you don't need a powerhouse CPU for gaming, especially when you're on a tight budget.
...
* **Case Fans:** Although the case does ship with two [case fans](/budget-pcs/case-fans/) pre-installed, they're both mounted to the case's front panel and they're intake fans. Unfortunately, the case doesn't include an exhaust fan. We'd highly recommend adding an exhaust fan ASAP, as it's important to have both air intake and exhaust to maintain a steady stream of cool air. You also may want to add a [fan controller](/budget-pcs/case-fans/controller/) to the build. This is a great way to easily control the speed of your case fans at all times. 
