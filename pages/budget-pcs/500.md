...
Perfect for a budget gaming computer, the i3-7100 packs one heck of a punch, all inside this new Kaby Lake chip. 

By harnessing of the power of the new Kaby Lake architecture, a 3.9 GHz clock speed, and hyperthreading, this processor has it all. 
...
Funny, right?  
 ...
 When paired with a GTX 1050 ti, RX 460, and RX 470, fps is relatively the same across the boards.

 What does this mean? 

 It means the processor is more than capable of keeping up with the graphics cards, so you do not have to worry about bottlenecking. 
