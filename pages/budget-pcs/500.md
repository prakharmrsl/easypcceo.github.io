...
<table class="basic-table table-colorful" align="center">
	...
	<tr>
		...
		<td class="components">
			<ul>
			<li>3.5 GHz Core Clock</li>
			<li>3.7 GHz Turbo Clock</li>
			<li>4 Cores</li>
			</ul>
		</td>
	...
	<tr>
		...
		<td class="components">
			<ul>
			<li>1.168 GHz Core Clock</li>
			<li>1.31 GHz Boost Clock</li>
			<li>4GB DDR5 VRAM</li>
			</ul>
		</td>
	...
	<tr>
	<td colspan="4"><a class="big-button" target="_blank" href="https://www.amazon.com/gp/aws/cart/add.html?AssociateTag=flarp0c-20&ASIN.1=B079D3DBNM&Quantity.1=1&ASIN.2=B07FVKWLQK&Quantity.2=1&ASIN.3=B01ARHBBPS&Quantity.3=1&ASIN.4=B0088PUEPK&Quantity.4=1&ASIN.5=B06Y5WGXX3&Quantity.5=1&ASIN.6=B071SHFRTP&Quantity.6=1&ASIN.7=B01B72VXE6&Quantity.7=1">Check Price on Amazon</a></td>
</tr>
</table>
</div>
...
<div class="content">
<div class="img">
<a target="_blank" href="https://amzn.to/2VqBRVm"><img alt="WD Caviar Blue 1TB" src="/img/hdd/1tb.png" /></a>
</div>
<div class="text">
