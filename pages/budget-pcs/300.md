...
The most important component of any gaming PC is the GPU. 

As long as you have a processor that’s fast enough to keep up with your GPU and sufficient RAM, you’re pretty much good to go. Make sure your GPU has a good memory clock speed though. More information on that [here](/gpu-memory-clock-speed/). 
...
* A good [CPU](/cpu/) (it doesn’t need to be top-of-the-line) 
...
Or, if you want something smaller, check out our article about the [smallest micro atx cases](/pc-cases/smallest-micro-atx-cases/) on the market.
