...
Housing everything in your build, the case is often an overlooked part. 
...
These factors must be kept in mind when deciding on a case. This is why the Cougar MX200 is the case of choice. 

This case features 2 120mm fan vents with pre-installed red LED's. It is sleek, refined, spacious, and compatible with the build. Furthermore, cable management is no problem with this case.

Cable management is important to keep in the back of your head when wiring your PC.

Not only does it make the inside of your PC look better, it improves airflow. This helps to keep your PC nice and cool while you're pushing your rig to the limit. 
...
DDR4 Memory - 2400/ 2133 MHz
* Memory Channel - Dual
* DIMM Slots - 2
* Max Memory (GB) - 32

Here at Easy PC, getting the best bang for your buck is high on the list of priorities. This means recommending parts that will last a long time. That is why this motherboard was picked for the build.
...
8GB has been the standard for a long time in the gaming community. Recommended for most games, it will do you just fine. 
...
The XFX - Radeon RX 460 4GB Double Dissipation Video Card made the cut for this build. 

Not only is this card rocking 4GB of DDR5 dedicated memory, it has a core clock of 1.09 GHz. 
...
For the price, the Radeon RX 460 4GB is the best choice for this build. 
...
Buy yours [here](https://www.amazon.com/gp/product/B01K1JVCRE/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B01K1JVCRE&linkCode=as2&tag=flarp0c-20&linkId=283f47c8d9a10d97dae4edbbf581fd88)

![RX 460 4GB](/img/gpu/rx 460 4gb.png "Radeon RX 460 4GB")

### The Power Supply 

Finding a reliable power supply with sufficient wattage can be hard. With many factors to consider including wattage, efficieny, and whether or not to choose a modular power supply, it can be a daunting task. 
...
* [Radeon RX 460 4GB Graphics Card - $179](https://www.amazon.com/gp/product/B01K1JVCRE/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B01K1JVCRE&linkCode=as2&tag=flarp0c-20&linkId=283f47c8d9a10d97dae4edbbf581fd88)
