...
These must be kept in mind when deciding on a case. That is why the Cougar MX200 is the case of choice. 

This case features 2 120mm fan vents with pre-installed red LED's. It is sleek, refined, spacious, and compatible with the build. 
