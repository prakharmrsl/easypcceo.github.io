---
title: Zcash Mining Hardware Comparison
...
This card has a hashrate of 800 Sol/s and a power consumption of 260 W. It is the most powerful Zcash miner on the market! 
...
When you buy an RX 480, you can expect to see a large profit margin. It has a hashrate of 320 Sol/s and a power consumption of 130 W.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/x1eB94aMBu4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>

## Zcash ASIC

There are not any ASICs for Zcash mining. 

However, this may not necessarily be a bad thing. 

ASICs promote centralization and drive block difficulty sky high, rendering it impossible for the average Joe to profitably confirm the network. 

By remaining ASIC resistant, Zcash mining stays profitable for the little guy, which promotes decentralization of the token. 

## Zcash Mining Algorithm - Equihash 

According to the project's blog, Equihash was chosen because it is ASIC resistant: 

<blockquote source="https://blog.z.cash/why-equihash/">
	<p>Equihash is a memory-oriented Proof-of-Work, which means how much mining you can do is mostly determined by how much RAM you have. We think it is unlikely that anyone will be able to build cost-effective custom hardware (ASICs) for mining in the foreseeable future… we may change the Proof-of-Work again, if we find some flaw in Equihash or if we find another Proof-of-Work algorithm which offers higher assurance.
	</p>
</blockquote>
...
If you decide to invest in a mining GPU, you'll have to buy the necessary peripherals to go with it (case, power supply, motherboard, processor, etc.) – after all, a mining setup is just a computer optimized for mining. 

With that in mind, here are some of the components you'll need: 

* Motherboard - make sure yours has enough PCI slots to accomodate your GPUs (If you buy 3 GPUs, you'll need 3 PCI slots!)
* Riser cables – you'll need one for each GPU 
* DDR4 RAM - 4GB is the minimum 
* Case – you can go with a standard case, though an open air mining case is ideal for cooling
* SSD – solid state drives increase read/write speeds
* PSU – your power supply will need to be sufficient for the entire build, so check your estimated power consumption! 

<a target="_blank" rel="nofollow" href="https://blockoperations.com/how-to-build-and-run-a-6-gpu-mining-rig-for-zcash-or-ethereum-with-nvidia-gtx-1070/">Block Operations</a> has a great Zcash setup guide:
...
7. Riser: [S-Union 4 in 1 PCI-E Riser 1 to 16 Adapter Board](https://amzn.to/2JlbnxD){: target="_blank"}
8. GPU: Choose one of the three listed above!

For their full setup guide, click <a target="_blank" rel="nofollow" href="https://blockoperations.com/how-to-build-and-run-a-6-gpu-mining-rig-for-zcash-or-ethereum-with-nvidia-gtx-1070/">here</a>.

## Zcash Mining Software

The best Zcash mining software for you depends on your mining hardware – some will best suit Nvidia GPUs, while others are preferable for AMD GPUs.

*Consider the following mining software for your setup:* 

* [Silentarmy](https://github.com/mbevand/silentarmy){: target="_blank"}
* [nheqminer](https://github.com/nicehash/nheqminer/releases){: target="_blank"} 
* [Claymore Miner](https://github.com/nanopool/Claymore-Dual-Miner/releases){: target="_blank"}
* [Optiminer](http://optiminerzcash/){: target="_blank"}

## Zcash Mining Pools 

Mining pools are a great tool for the average Joe looking to generate passive income. 

Here's why: 

Rather than trying to validate a block on your own (which may take a while given block difficulty), you can team up with other likeminded people and validate the block together. 

Rewards are paid out in proportion to the amount of power you contributed. If 25% of the energy used to validate the block was from you, you'll receive 25% (minus a small pool fee) of the block reward!

Joining a mining pool will yield faster results, and increase your chances of successfully mining a block.

**Here are some mining pools to try:** 

* [Coinotron](http://zcash.miningspeed.com/){: target="_blank"}
* [Mining Pool Hub](https://zcash.miningpoolhub.com/){: target="_blank"}
* [Slushpool](https://slushpool.com/home/){: target="_blank"}
* [flypool](http://zcash.flypool.org/){: target="_blank"}

## Why Should You Mine Zcash? 

* Mining Zcash is far more profitable than mining Bitcoin – rather than investing in expensive Bitcoin mining hardware (that won't even turn a profit), you can exchange the Zcash you have mined for Bitcoin.

*  Zcash can be sold directly on major exchanges, or traded for other cryptocurrencies. 

* Zcash is based on Bitcoin's protocol, with the users' privacy in mind.

* The token has a large market capitalization, just above one billion dollars. 

* It is one of the best cryptocurrencies to mine, in terms of profitability 
...
<figure>
	<img alt="projected Zcash earnings" src="/img/cryptocurrency/zcash-profit.png" />
